...
Served as part of the unified `/vo2/...` URL space. From the repo root:

```bash
cd website && python3 -m http.server 8000
```

Then open `http://localhost:8000/vo2/go/`. The page must be served over
HTTP — `file://` blocks WASM imports.
