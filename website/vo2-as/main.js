// ----------------------------------------------------------------
// Load WASM (AssemblyScript build)
//
// The asc-generated loader (build/release.js) uses top-level await to
// instantiate the WASM at module-load time, so importing it gives us
// a ready-to-call analyze_gpx synchronously after the dynamic import.
// ----------------------------------------------------------------

// Size of build/release.wasm in bytes. Update if the binary changes
// (the asbuild script prints the new size).
const WASM_SIZE_BYTES = 46_246;
